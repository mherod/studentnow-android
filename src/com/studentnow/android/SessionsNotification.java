...
/**
 * Helper class for showing and canceling sessions notifications.
 * <p>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class SessionsNotification {
	/**
	 * The unique identifier for this type of notification.
	 */
	private static final String NOTIFICATION_TAG = "Sessions";
	 ...
	 * presentation of sessions notifications. Make sure to follow the <a
	...
	public static void notify(final Context context,
		...
		exampleItem.setSpan(new ForegroundColorSpan(Color.WHITE), 0,
				exampleItem.length(), 0);
		exampleItem.append("   Example content");

		final String ticker = exampleString;
		final String title = res.getString(
				R.string.sessions_notification_title_template, exampleString);
		final String text = res.getString(
				R.string.sessions_notification_placeholder_text_template,
				exampleString);
